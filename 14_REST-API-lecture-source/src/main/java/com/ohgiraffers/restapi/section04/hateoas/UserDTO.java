...
//    @NotNull(message = "아이디는 반드시 입력되어야합니다")
    private String id;
    private String pwd;
    @Size(min =2, message = "이름은 두글자 이상 입력해야 나갑니다")
    private String name;
    ...
    public @NotNull(message = "아이디는 반드시 입력되어야합니다") String getId() {
        return id;
    }

    public void setId(@NotNull(message = "아이디는 반드시 입력되어야합니다") String id) {
        this.id = id;
    }
